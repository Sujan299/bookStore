            ...
            <div className='mx-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10'>
                <div className='order-2 md:order-1 w-full md:w-1/2 mt-12 md:mt-32'>
                    <div className='space-y-12'>
                        ...
                        <p className='text-xl'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magni cupiditate et, non a repellendus molestias consequuntur culpa quo incidunt at dignissimos fugit nobis temporibus libero? Error atque voluptate vero obcaecati.</p>
